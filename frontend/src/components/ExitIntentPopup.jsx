    ...
    <div className="fixed inset-0 z-[200] flex items-center justify-center px-4"
      ...
      <div className="relative bg-white max-w-lg w-full shadow-2xl overflow-hidden rounded-2xl animate-fade-in">
        ...
        <div className="p-10 text-center">
          ...
          <p className="text-gray-500 text-sm mb-2 font-light">Join the Thaarai Atelier and receive</p>
          ...
          {submitted ? (
            <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-6">
              <p className="text-emerald-700 font-bold uppercase tracking-widest text-sm">✓ Welcome to Thaarai Atelier!</p>
