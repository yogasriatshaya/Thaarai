...
export default function Contact() {
  ...
  return (
    <div className="bg-white min-h-screen animate-fade-in">
      {/* Hero Section */}
      <section className="relative py-20 bg-gradient-to-b from-[#000000]/10 to-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <h1 className="font-serif text-4xl md:text-5xl font-bold text-gray-900 leading-tight mb-6">
              We'd Love to <span className="italic" style={{ color: '#000000' }}>Hear</span> From You
            </h1>
              ...
              <div className="space-y-8">
                ...
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 rounded-full flex items-center justify-center shrink-0" style={{ backgroundColor: 'rgba(171, 160, 227, 0.1)' }}>
                    <svg className="w-5 h-5" style={{ color: '#000000' }} fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
                ...
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 rounded-full flex items-center justify-center shrink-0" style={{ backgroundColor: 'rgba(171, 160, 227, 0.1)' }}>
                    <svg className="w-5 h-5" style={{ color: '#000000' }} fill="currentColor" viewBox="0 0 24 24">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:border-[#000000] transition-colors"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      required
                      className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:border-[#000000] transition-colors bg-white"
                    >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={5}
                    className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:border-[#000000] transition-colors resize-none"
                ...
                <button
                  ...
                  onMouseLeave={e => !loading && (e.currentTarget.style.backgroundColor = '#000000')}
                >
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto px-6">
          <div className="text-center mb-12">
            <span className="text-[10px] font-bold uppercase tracking-[0.3em]" style={{ color: '#000000' }}>FAQ</span>
            ...
            {[
              {
                ...
                a: 'We offer free shipping on qualifying orders. Standard delivery takes 5-7 business days (India) or 7-10 business days (US), and express delivery is available for an additional charge.',
              },
              {
